...
export function placeStepsIcon() {
  const sz = px(36)
  const angle = (2 * 30 - 90) * Math.PI / 180
  ...
  hmUI.createWidget(hmUI.widget.IMG, { x, y, w: sz, h: sz, src: 'steps/gray.png' })
  hmUI.createWidget(hmUI.widget.IMG_LEVEL, {
    x, y, w: sz, h: sz,
    image_array: Array.from({ length: 5 }, function(_, i) { return 'steps/' + i + '.png' }),
    image_length: 5,
