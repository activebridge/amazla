#!/usr/bin/env python3
"""Generate minute digit PNGs using Varela Round with black outline."""
...
REF_SIZE = 480
REF_DIGIT_H = 42  # smaller than hours (56)
OUTLINE_W = 4
...
for res_name, res_width in RESOLUTIONS.items():
    ...
    out_dir = os.path.join(BASE_DIR, "assets", res_name, "time-min")
