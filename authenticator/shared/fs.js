// Storage for TOTP secrets — the logging in the upstream copy of this file is
// commented out on purpose: it printed every file's full contents.
...
//   - up to 3.1.5 the app wrote through @zos/fs, which is UTF-8;
//   - the 3.1.6 v1 build wrote UTF-16LE (this file's upstream `str2ab`, two bytes
//     per char), so GTR 3 / GTS 3 / Band 7 installs carry UTF-16 files.
// Guessing wrong yields mojibake and a JSON.parse throw, which for accounts.json
// reads as "all my accounts are gone" until the phone syncs them back.
